...
public class AuthorizationTest {
    ...
    public void successAuthorizationTest() {
        EspressoWaitUtils.waitForView(authorizationPage.getAuthorLoginField, 8000);
        ...
        EspressoWaitUtils.waitForView(mainPage.getListNewsMain, 8000);
    ...
    public void logOutTest() {
        ...
        EspressoWaitUtils.waitForView(mainPage.getListNewsMain, 8000);
        authorizationPage.logOut();
        EspressoWaitUtils.waitForView(authorizationPage.getTextPageAuthorization, 8000);
        onView(authorizationPage.getTextPageAuthorization).check(matches(withText("Authorization")));
