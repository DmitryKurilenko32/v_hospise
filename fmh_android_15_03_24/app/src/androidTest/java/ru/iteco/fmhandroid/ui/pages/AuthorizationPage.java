...
public class AuthorizationPage {
    ...
    public void login (String login ,String password){
        EspressoWaitUtils.waitForView(getAuthorLoginField , 8000);
    ...
    public void logOut (){
        EspressoWaitUtils.waitForView(getButtonLogOut , 8000);
        onView(getButtonLogOut).check(matches(isDisplayed()));
        onView(getButtonLogOut).perform(click());
        EspressoWaitUtils.waitForView(getButtonLogout2 , 8000);
